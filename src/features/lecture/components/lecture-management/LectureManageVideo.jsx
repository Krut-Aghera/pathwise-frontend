...
import { FileVideo, Upload, Trash2 } from "lucide-react"
...
const LectureManageVideo = ({
    ...
    const video = lecture?.video ?? null
    ...
    const handleConfirmRemoveVideo = async () => {
        ...
        const result = await onRemoveVideo?.()
    ...
    return (
        <>
                ...
                <div className="p-4 sm:p-5">
                    {hasVideo ? (
                        ...
                        >
                            ...
                            "
                            >
                                Upload a video to make this lecture available to
                                students.
                            </p>
            ...
            >
                ...
                "
                >
                    Removing this video will leave the lecture without a video.
                    You can upload a video again later.
                </p>
            </ConfirmDialog>
        </>
    )
