...
const useLectureVideo = () => {
    ...
    const uploadLectureVideo = async (lectureId, video, sectionId) => {
        try {
            const result = await uploadLectureVideoMutation({
                lectureId,
                video,
                sectionId,
            }).unwrap()
    ...
    const removeLectureVideo = async (lectureId, sectionId) => {
        try {
            const result = await removeLectureVideoMutation({
                lectureId,
                sectionId,
            }).unwrap()
